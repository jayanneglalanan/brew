...
const VARIANTS: Record<string, { bg: string; fg: string; border: string }> = {
  ...
  amber: { bg: colors.lowSoft, fg: colors.low, border: '#E8D3A6' },
...
const styles = StyleSheet.create({
  badge: { paddingHorizontal: 6, paddingVertical: 2, borderRadius: radius.sm, borderWidth: 1, alignSelf: 'center', maxWidth: '100%', flexShrink: 1 },
