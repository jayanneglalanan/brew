...
const hasSnapshot = snapshot !== null && snapshot.seedSignature === SEED_SIGNATURE;

const initialProducts = hasSnapshot ? snapshot.products : seedProducts;
const initialInventory = hasSnapshot ? snapshot.inventory : seedInventory;
